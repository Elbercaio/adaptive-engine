...
router_v2.register(
    "prerequisite_knowledge_component", api_v2.PrerequisiteKnowledgeComponentViewSet
)
...
urlpatterns = [
    ...
    path(
        "engine/api/", include(router_v2.urls)
    ),  # included for backcompatibility through sep 2018
]
